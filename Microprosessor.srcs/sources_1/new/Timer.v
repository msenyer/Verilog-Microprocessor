...
// 
// Create Date: 15.03.2018 11:35:06
// Design Name: Timer
// Module Name: Timer
...
// Description: 
// 1. The timer module can trigger the interupt based on the timer that be set by 
//   configured the interupt rate. 
// 2. It has 4 address that has function as enabled interupt, set timer, reset timer,
//    and report current timer
// Revision: v.1
...
module Timer(
        ...
        always@(posedge CLK) begin
            ...
            else if(BUS_INTERRUPT_ACK) //response that the interupt is already received 
