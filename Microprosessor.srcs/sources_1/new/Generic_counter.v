...
// 
// Create Date: 16.10.2017 21:15:04
// Design Name: End packet
// Module Name: Generic_counter
// Project Name: 
// Target Devices: DIGILENT BASYS3
// Tool Versions: 3
// Description: 
// Will create 10 Hz enable signal to send the packet data

// Revision:
// Revision 0.01 - File Created
// Additional Comments:
// will integrated will the IR transmitter top level 
//////////////////////////////////////////////////////////////////////////////////
...
//Synchronous logic for Trigger_out
    ...
    always@(posedge CLK) begin
        if(RESET)
            ...
            if(ENABLE_IN && (count_value < COUNTER_MAX/40))   //keep the trigger high u until counter_max/40
                Trigger_out <= 1;
            else
                Trigger_out <= 0;
        end
